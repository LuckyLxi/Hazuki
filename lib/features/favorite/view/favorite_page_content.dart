...
class FavoriteBackToTopButton extends StatelessWidget {
  const FavoriteBackToTopButton({
    super.key,
...
class FavoritePageContentSection extends StatelessWidget {
  const FavoritePageContentSection({
    super.key,
