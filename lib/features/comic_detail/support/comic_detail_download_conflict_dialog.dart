...
enum ComicDetailDownloadedChapterAction { skip, continueToRedownload }
...
showComicDetailSkipDownloadedChaptersDialog(
  ...
  return _showAnimatedDownloadConflictDialog<
    ComicDetailDownloadedChapterAction
  >(
    context,
    ...
    onSecondaryAction: (dialogContext) => Navigator.of(
      dialogContext,
    ).pop(ComicDetailDownloadedChapterAction.continueToRedownload),
    primaryActionLabel: strings.downloadsSkipDownloadedAction,
    onPrimaryAction: (dialogContext) => Navigator.of(
      dialogContext,
    ).pop(ComicDetailDownloadedChapterAction.skip),
  );
}
