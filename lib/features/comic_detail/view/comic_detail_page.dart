...
part 'comic_detail_app_bar.dart';
part 'comic_detail_cover.dart';
part 'comic_detail_cover_actions.dart';
part 'comic_detail_favorite_actions.dart';
part 'comic_detail_header.dart';
part 'comic_detail_lifecycle_actions.dart';
part 'comic_detail_meta.dart';
part 'comic_detail_meta_section.dart';
part 'comic_detail_panels.dart';
part 'comic_detail_reader_actions.dart';
part 'comic_detail_runtime.dart';
part 'comic_detail_scaffold.dart';
part 'comic_detail_sections.dart';
part 'comic_detail_theme_support.dart';
