...
Widget buildSourceUpdateDownloadingScene({
      ...
      buildSourceUpdatePanel(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              indeterminate ? subtitle : restartHint,
...
Widget buildSourceUpdateHeader({
  required ColorScheme colorScheme,
  required TextTheme textTheme,
  ...
  return Column(
    ...
    children: [
      Row(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          buildSourceUpdateLeadingIcon(icon: icon, accent: accent),
...
Widget buildSourceUpdateVersionRow({
  required ColorScheme colorScheme,
  required TextTheme textTheme,
  required IconData icon,
  required Color accent,
...
Widget buildSourceUpdateErrorCard({
  required ColorScheme colorScheme,
  required TextTheme textTheme,
...
Widget buildSourceUpdateLeadingIcon({
  required IconData icon,
  required Color accent,
}) {
  return Container(
